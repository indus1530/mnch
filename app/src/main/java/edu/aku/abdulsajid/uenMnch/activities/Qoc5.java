...
import edu.aku.abdulsajid.uenMnch.databinding.ActivityQoc5Binding;
...
//        qoc5.put("qe0503c", bi.qe0503c.getText().toString().trim().length() > 0 ? bi.qe0503c.getText().toString() : "0");
    ...
    public void onCheckedChanged(RadioGroup radioGroup, int i) {
        ...
        bi.qe0501b.setEnabled(bi.qe0501ab.isChecked());

        bi.qe0502b.setEnabled(bi.qe0502ab.isChecked());

        bi.qe0503b.setEnabled(bi.qe0503ab.isChecked());
