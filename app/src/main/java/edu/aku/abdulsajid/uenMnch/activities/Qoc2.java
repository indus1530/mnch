...
import edu.aku.abdulsajid.uenMnch.databinding.ActivityQoc2Binding;
...
//        qoc2.put("qb0203c", bi.qb0203c.getText().toString().trim().length() > 0 ? bi.qb0203c.getText().toString() : "0");
    ...
    public void onCheckedChanged(RadioGroup radioGroup, int i) {
        ...
        bi.qb0201b.setEnabled(bi.qb0201ab.isChecked());

        bi.qb0202b.setEnabled(bi.qb0202ab.isChecked());

        bi.qb0203b.setEnabled(bi.qb0203ab.isChecked());
