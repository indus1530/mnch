...
import edu.aku.abdulsajid.uenMnch.databinding.ActivityQoc6Binding;
...
//        qoc6.put("qf0604c", bi.qf0604c.getText().toString().trim().length() > 0 ? bi.qf0604c.getText().toString() : "0");
    ...
    public void onCheckedChanged(RadioGroup radioGroup, int i) {
        ...
        bi.qf0601b.setEnabled(bi.qf0601ab.isChecked());

        bi.qf0602b.setEnabled(bi.qf0602ab.isChecked());

        bi.qf0603b.setEnabled(bi.qf0603ab.isChecked());

        bi.qf0604b.setEnabled(bi.qf0604ab.isChecked());
