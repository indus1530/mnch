...
import edu.aku.abdulsajid.uenMnch.databinding.ActivityQoc4Binding;
...
//        qoc4.put("qd0404c", bi.qd0404c.getText().toString().trim().length() > 0 ? bi.qd0404c.getText().toString() : "0");
    ...
    public void onCheckedChanged(RadioGroup radioGroup, int i) {
        ...
        bi.qd0401b.setEnabled(bi.qd0401ab.isChecked());

        bi.qd0402b.setEnabled(bi.qd0402ab.isChecked());

        bi.qd0403b.setEnabled(bi.qd0403ab.isChecked());

        bi.qd0404b.setEnabled(bi.qd0404ab.isChecked());
